						...
						<div className="inputDetails">
							<div className="newDrop">
								...
								<div className="radioField">
									<input type="radio" value="male" name="Male" className="rad" />
									<label>Male</label>
									<input type="radio" value="female" name="Female" className="rad" />
									<label>Female</label>
									<input type="radio" value="not to say" name="undefine" className="rad" />
